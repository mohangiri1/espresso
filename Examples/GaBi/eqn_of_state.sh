...
EOF
    ...
    mpirun -np 32 pw.x < celldm.${percent_change}.in > "celldm.${percent_change}.out"
    rm -r ./output/
    rm -r pw.x < celldm.${percent_change}.in
...
attachment="volume_optimized.pdf"
